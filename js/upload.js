  ...
  methods: {
    ...
    fetchDrawAndUpload: function() {
      ...
      return request.post({
        ...
        console.log("serializeDrawInfo:", this.serializeDrawInfo(this.info));
        return this.upload();
      });
    },
    ...
    upload: function() {
      ...
      return request.post({
        ...
        params: this.serializeDrawInfo(this.info),
        headers: headers
      }, (err, res, body) => {
        var ref;
        console.log(`Upload status code: ${res.statusCode}`);
        if ((ref = res.statusCode) === 200 || ref === 302) {
          this.getTotalDraws();
          return this.getLastDraw();
        } else {
          return alert(`Upload error: ${res.statusCode} \n ${body}`);
        }
      });
    }
  },
