...
plot = function() {
  var color, data, dataIntermediate, k, keys, l, m, ref, results, results1, svg, xAxis, xRange, xmax, xmin, yAxis, yRange, ymax, ymin;
  ...
  svg.append('g').append('text').attr('fill', '#93a1a1').attr('x', xRange(Math.round((xmin + xmax) / 2))).attr('y', yRange(ymax)).attr('dy', '-0.35em').attr('text-anchor', 'middle').text('Number frequencies');
